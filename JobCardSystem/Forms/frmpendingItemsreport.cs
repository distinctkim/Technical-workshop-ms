...
namespace JobCardSystem.Forms
{
    ...
    public partial class frmpendingItemsreport : MetroFramework.Forms.MetroForm 
    {
        private string conn;
        ...
        private void frmpendingItemsreport_Load (object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    adapter = new MySqlDataAdapter ("select * from tblconequip WHERE status = 'Pending'", connect);
                    DS = new DataSet ();
                    adapter.Fill (DS);
                    ...
                    kdvequipcon.Columns [7].HeaderText = "ClientEmail";
        ...
        private void txtclient_TextChanged (object sender, EventArgs e)
        {
            ...
            sqlcon.Open ();
            string query = string.Format ("Select * from tblconequip where cname like '%{0}%' AND status = 'Pending'" , txtclient.Text);
