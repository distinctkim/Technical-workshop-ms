...
{
    public partial class frmExternalCommAdmin : MetroFramework.Forms.MetroForm 
    {
        private string conn;
        ...
        private void frmExternalCommAdmin_Load (object sender, EventArgs e)
        {
            selectCombo ();
            customergrid ();
        }
        ...
        {
            frmcommunicationadmin frm = new Forms.frmcommunicationadmin ();
            frm.Show ();
            this.Hide ();
        }
    }
