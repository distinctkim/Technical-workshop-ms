...
{
    public partial class frmviewcleareditems : MetroFramework.Forms.MetroForm 
    {
        private string conn;
        ...
        private void gridcleared()
        {
            try
            {
                ...
                {
                    adapter = new MySqlDataAdapter ("select * from tblbill WHERE status = 'ItemCleared'", connect);
                    DS = new DataSet ();
                    adapter.Fill (DS);
        ...
        private void txtresamnt_TextChanged (object sender, EventArgs e)
        {
            //int a = Convert.ToInt32 (txttamnt.Text);
            //int b = Convert.ToInt32 (txtre.Text);
            //int c = a - b;
            //txtresamnt.Text = Convert.ToString (c);
            txtresamnt.Text = Convert.ToString (Convert.ToDouble (txttamnt.Text) - Convert.ToDouble (txtre.Text));
