...
{
    public partial class frmviewuncleareditems : MetroFramework.Forms.MetroForm 
    {
        private string conn;
        ...
        private void load()
        {
            try
            {
                ...
                {
                    adapter = new MySqlDataAdapter ("select * from tblbill WHERE status = 'YettobeCleared'", connect);
                    DS = new DataSet ();
                    adapter.Fill (DS);
                ...
                total ();
                totalre ();
                txtresamnt.Text = Convert.ToString (Convert.ToDouble (txtre.Text) - Convert.ToDouble (txttamnt.Text));
        ...
        private void frmviewuncleareditems_Load (object sender, EventArgs e)
        {
        ...
        public void totalre ()
        {
            ...
            for (int i = 0; i < kdvclientequipmentgrid.Rows.Count; ++i)
            {
                sum += Convert.ToDouble (kdvclientequipmentgrid.Rows [i].Cells [21].Value);
            }
        ...
        {
            frmreportsmenu frm = new frmreportsmenu ();
            frm.Show ();
            this.Hide ();
        }
        ...
        private void button4_Click (object sender, EventArgs e)
        {
            ...
            printer.Title = "Uncleared Client Equipment Report";

            printer.SubTitle = "Equipment Clearance Summary";
