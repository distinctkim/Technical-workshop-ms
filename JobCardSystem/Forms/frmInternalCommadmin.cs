...
{
    public partial class frmInternalCommadmin : MetroFramework.Forms.MetroForm 
    {
        private string conn;
        ...
        private void frmInternalCommadmin_Load (object sender, EventArgs e)
        {
            loadgrid ();
            selectCombo ();
        }
        ...
        {
            this.Hide ();
            frmcommunicationadmin frm = new frmcommunicationadmin ();
            frm.Show ();
