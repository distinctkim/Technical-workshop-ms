...
{
    public partial class frmviewloggedequip : MetroFramework.Forms.MetroForm 
    {
        private string conn;
        ...
        private void frmviewloggedequip_Load (object sender, EventArgs e)
        {
        ...
        {
            this.Hide ();
            Home loggedequip = new Forms.Home ();
            loggedequip.Show ();
        }
