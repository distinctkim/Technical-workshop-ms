...
{
    public partial class frmviewpickeditemstech : MetroFramework.Forms.MetroForm
    {
        private string conn;
        ...
        private void load()
        {
            ...
            try
            {
                ...
                {
                    adapter = new MySqlDataAdapter ("select * from tblcleareditems", connect);
                    DS = new DataSet ();
                    adapter.Fill (DS);
                    ...
                    kdvclientequipmentgrid.Columns [3].HeaderText = "ClearanceDate";
        ...
        private void frmviewpickeditemstech_Load (object sender, EventArgs e)
        {
        ...
        {
            frmitempickup  frm = new Forms.frmitempickup ();
            frm.Show ();
            this.Hide ();
        }
        ...
        {
            frmitempickup select = new frmitempickup ();
            select.txtclearanceid.Text = kdvclientequipmentgrid.CurrentRow.Cells [0].Value.ToString ();
            select.cmbxbid.Text = kdvclientequipmentgrid.CurrentRow.Cells [1].Value.ToString ();
            select.txtcid.Text = kdvclientequipmentgrid.CurrentRow.Cells [2].Value.ToString ();
            select.txtcleardate.Text = kdvclientequipmentgrid.CurrentRow.Cells [3].Value.ToString ();
            select.txtdate.Text = kdvclientequipmentgrid.CurrentRow.Cells [4].Value.ToString ();
            select.txtbilldate.Text = kdvclientequipmentgrid.CurrentRow.Cells [5].Value.ToString ();
            select.txtequipmentid.Text = kdvclientequipmentgrid.CurrentRow.Cells [6].Value.ToString ();
            select.txtequipmentname.Text = kdvclientequipmentgrid.CurrentRow.Cells [7].Value.ToString ();
            select.txtequipmentserial.Text = kdvclientequipmentgrid.CurrentRow.Cells [8].Value.ToString ();
            select.txtclientname.Text = kdvclientequipmentgrid.CurrentRow.Cells [9].Value.ToString ();
            select.txtclientemail.Text = kdvclientequipmentgrid.CurrentRow.Cells [10].Value.ToString ();
            select.txtqamnt.Text = kdvclientequipmentgrid.CurrentRow.Cells [11].Value.ToString ();
            select.txttaxrate.Text = kdvclientequipmentgrid.CurrentRow.Cells [12].Value.ToString ();
            select.txttxamnt.Text = kdvclientequipmentgrid.CurrentRow.Cells [13].Value.ToString ();
            select.txtgamnt.Text = kdvclientequipmentgrid.CurrentRow.Cells [10].Value.ToString ();
            select.txtpamnt.Text = kdvclientequipmentgrid.CurrentRow.Cells [11].Value.ToString ();
            select.txtbalance.Text = kdvclientequipmentgrid.CurrentRow.Cells [12].Value.ToString ();
            select.txtstatus.Text = kdvclientequipmentgrid.CurrentRow.Cells [13].Value.ToString ();
            select.ShowDialog ();
            this.Hide();
